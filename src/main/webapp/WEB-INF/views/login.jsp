...
<div class="content">
	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" />
			</div>
		</div>
		<div class="form-group">
	...
	<form class="register-form" action="rest/user/register" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="username" value=""/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">密码</label>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2017 &copy; Dev By ningwu_05@126.com - WSS
</div>
<!-- END COPYRIGHT -->
